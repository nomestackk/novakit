...
---@class NovaKIT.Stylebox: middleclass.Class
---@operator call: NovaKIT.Stylebox
local Stylebox = middleclass 'Stylebox'

---@param settings? NovaKIT.StyleboxSettings
function Stylebox:initialize(settings)
  settings = settings or EMPTY
  self.color = settings.color or { 0.75, 0.75, 0.75, 1 }
  self.shrink = settings.shrink or 4
  self.border = settings.border or 0.5
  self.borderColor = settings.borderColor or { 0.5, 0.5, 0.5, 1 }
